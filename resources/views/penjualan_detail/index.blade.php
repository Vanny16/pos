                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <form action="{{ route('transaksi.simpan') }}" class="form-penjualan" method="post">
                                ...
                                <div class="form-group row">
                                    <label for="payment_type" class="col-lg-2 control-label">Payment Method</label>
                                    <div class="col-lg-8">
                                ...
                                <div class="form-group row">
                                    <label for="kembali" class="col-lg-2 control-label">Note</label>
                                    <div class="col-lg-8">
                                        <textarea class="form-control" id="note" name="note" placeholder="Additional details"></textarea>
